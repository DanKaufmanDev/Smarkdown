...
export default function NoteEditor() {
  const { currentNote, setField, saveNote, deleteNote, isSaving } = useNoteStore();
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-900" style={{ height: '100vh' }}>
      {/* Editor Header */}
      ...
      {/* Mode Toggle */}
      <div className="border-b border-slate-700 px-4 py-2 bg-slate-800 flex-shrink-0">
      ...
      <div className="flex-1 overflow-hidden" style={{ maxHeight: 'calc(100vh - 390px)' }}>
        {renderContent()}
      </div>
